  ...
  return (
    <div className="w-full flex-col items-center">
      ...
      <div className="bg-slate-100 flex justify-center items-center mt-10 border rounded-full py-2 lg:w-[563px] lg:h-[84px] w-[360px] h-[52px] m-auto">
        <button className={`text-xs lg:text-lg px-5 py-2 rounded-full active:opacity-70 font-bold select-none flex justify-center items-center ${isData === false ? 'active lg:w-[243px] lg:h-[60px] w-[149px] h-[36px] bg-white text-black relative' : 'w-[149px] lg:w-[243px] text-slate-300'}`} onClick={() => handlePlanClick(false)}>
        ...
        <button className={`text-xs lg:text-lg px-5 py-2 rounded-full active:opacity-70 font-bold select-none flex justify-center items-center ${isData === true ? 'active lg:w-[243px] lg:h-[60px] w-[149px] h-[36px] bg-white text-black relative' : 'w-[149px] lg:w-[243px] text-slate-300'}`} onClick={() => handlePlanClick(true)}>
