...
import { getProvinceQLTN, getDistricts, getWards } from '@/services/api/provinces'
  ...
  return (
    <div className='w-full bg-m_backgound  flex flex-col items-center min-h-[70rem]'>
      ...
      <div className='max-w-[1140px] w-full'>
        ...
        {loading ? <div className='w-full flex justify-center items-center h-96'><MoonLoader color='#E50914' /></div> : <div>
            ...
            <div className='bg-white w-2/5 border-m_gray border-2 rounded-lg h-fit'>
              <div className='p-5 h-full'>
                ...
                <div className='flex w-full justify-between'>
                  <p className='font-bold text-lg'>{sim?.msid} - {sim?.telco}</p>
                  <CloseOutlined />
                </div>
                ...
                <div className='flex w-full justify-between my-4'>
                  ...
                  <div className='font-bold text-base'>
                    <FormattedNumber value={(sim ? sim.price ?? 0 : 0)} style='currency' currency='VND' />
                  </div>
                </div>
